...
// Rarity affects spawn weight. Used by the 3D engine and the Sheepdex.
...
export const SHEEP_TYPES = [
  ...
  { id: "ice",         name: "Ice Sheep",        wool: "#B5E3F5", accent: "#0EA5E9", meat: "Frosty Ribs",        rarity: "uncommon" },
  { id: "lava",        name: "Lava Sheep",       wool: "#FF6B35", accent: "#7A1D00", meat: "Spicy Sausage",      rarity: "rare" },

  { id: "rainbow",     name: "Rainbow Sheep",    wool: "#FF8AA1", accent: "#22D3EE", meat: "Rainbow Roast",      rarity: "rare" },
  { id: "galaxy",      name: "Galaxy Sheep",     wool: "#4338CA", accent: "#F472B6", meat: "Cosmic Cutlet",      rarity: "rare" },
  ...
  { id: "tiger",       name: "Tiger Sheep",      wool: "#FFA45B", accent: "#1F1F1F", meat: "Striped Steak",      rarity: "uncommon" },
  ...
  { id: "gold",        name: "Golden Sheep",     wool: "#FFD54A", accent: "#7A5A00", meat: "Golden Goodie",      rarity: "rare" },

  { id: "silver",      name: "Silver Sheep",     wool: "#D4D7DC", accent: "#6B7280", meat: "Silver Slice",       rarity: "uncommon" },
  { id: "diamond",     name: "Diamond Sheep",    wool: "#A7F3D0", accent: "#0EA5E9", meat: "Crystal Cutlet",     rarity: "rare" },
  { id: "emerald",     name: "Emerald Sheep",    wool: "#34D399", accent: "#065F46", meat: "Gem Goulash",        rarity: "rare" },
  { id: "ruby",        name: "Ruby Sheep",       wool: "#EF4444", accent: "#7F1D1D", meat: "Ruby Roast",         rarity: "rare" },
  { id: "amethyst",    name: "Amethyst Sheep",   wool: "#C084FC", accent: "#5B21B6", meat: "Purple Patty",       rarity: "uncommon" },
  ...
  { id: "knight",      name: "Knight Sheep",     wool: "#B0BEC5", accent: "#374151", meat: "Armor Plate Ham",    rarity: "uncommon" },
  { id: "wizard",      name: "Wizard Sheep",     wool: "#A78BFA", accent: "#FACC15", meat: "Magic Meatballs",    rarity: "uncommon" },
  { id: "pirate",      name: "Pirate Sheep",     wool: "#9CA3AF", accent: "#7A1D00", meat: "Salty Steak",        rarity: "uncommon" },
  { id: "ninja",       name: "Ninja Sheep",      wool: "#374151", accent: "#FFEB99", meat: "Stealth Bites",      rarity: "uncommon" },
  ...
  { id: "robot",       name: "Robot Sheep",      wool: "#C5D6E0", accent: "#22D3EE", meat: "Bolt Burger",        rarity: "rare" },
  { id: "alien",       name: "Alien Sheep",      wool: "#86EFAC", accent: "#C084FC", meat: "UFO Patty",          rarity: "rare" },
  { id: "dragon",      name: "Dragon Sheep",     wool: "#FF6B35", accent: "#22D3EE", meat: "Fire Wing",          rarity: "rare" },
  { id: "unicorn",     name: "Unicorn Sheep",    wool: "#FFFFFF", accent: "#F472B6", meat: "Sparkle Steak",      rarity: "legendary" },
];
